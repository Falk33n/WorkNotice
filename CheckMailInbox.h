...
// Handles all the functionality for the initial check mail inbox popup
class CheckMailInbox : public NoticeBase {
    Q_OBJECT

  public:
    explicit CheckMailInbox(QObject *parent = nullptr);
